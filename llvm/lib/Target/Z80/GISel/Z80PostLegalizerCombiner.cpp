...
bool Z80PostLegalizerCombinerImpl::matchSelectAllOnes(
    MachineInstr &MI,
    std::function<void(MachineIRBuilder &)> &MatchInfo) const {
  ...
  return True && False && True->Value.isAllOnes() &&
         Helper.matchSelect(MI, MatchInfo);
}
...
bool Z80PostLegalizerCombiner::runOnMachineFunction(MachineFunction &MF) {
  ...
  CombinerInfo CInfo(/*AllowIllegalOps*/ true, /*ShouldLegalizeIllegal*/ false,
                     ...
                     F.hasMinSize());
  Z80PostLegalizerCombinerImpl Impl(MF, CInfo, &TPC, *VT, /*CSEInfo*/ nullptr,
