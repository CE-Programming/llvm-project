...
public:
  ...
  bool lowerConditionalCall(MachineIRBuilder &MIRBuilder,
                            CallLoweringInfo &Info, unsigned Cond) const;
...
private:
  bool lowerCallImpl(MachineIRBuilder &MIRBuilder, CallLoweringInfo &Info,
                     unsigned Cond) const;
  bool
