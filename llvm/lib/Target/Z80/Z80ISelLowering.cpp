...
Z80TargetLowering::Z80TargetLowering(const Z80TargetMachine &TM,
  ...
  setLibcall(RTLIB::NOT_I48,          "_i48not",     CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::AND_I48,          "_i48and",     CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::OR_I48,           "_i48or",      CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::XOR_I48,          "_i48xor",     CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::SHL_I48,          "_i48shl",     CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::SRA_I48,          "_i48shrs",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::SRL_I48,          "_i48shru",    CallingConv::Z80_LibCall   );
  setLibcall(RTLIB::SRL_I64,          "_llshru",     CallingConv::Z80_LibCall   );
  setLibcall(RTLIB::CMP_I32,          "_lcmpu",      CallingConv::Z80_LibCall_F );
  setLibcall(RTLIB::CMP_I48,          "_i48cmpu",    CallingConv::Z80_LibCall_F );
  ...
  setLibcall(RTLIB::CMP_I48_0,        "_i48cmpzero", CallingConv::Z80_LibCall_F );
  ...
  setLibcall(RTLIB::SCMP_I48,         "_i48cmps",    CallingConv::Z80_LibCall_F );
  ...
  setLibcall(RTLIB::NEG_I48,          "_i48neg",     CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::MUL_I48,          "_i48mulu",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::SDIV_I48,         "_i48divs",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::UDIV_I48,         "_i48divu",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::SREM_I48,         "_i48rems",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::UREM_I48,         "_i48remu",    CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::UDIVREM_I48,      "_i48dvrmu",   CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::POPCNT_I48,       "_i48popcnt",  CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::BITREV_I48,       "_i48bitrev",  CallingConv::Z80_LibCall   );
  setLibcall(RTLIB::BITREV_I64,       "_llbitrev",   CallingConv::Z80_LibCall   );
  setLibcall(RTLIB::BSWAP_I32,        "_lbswap",     CallingConv::Z80_LibCall   );
  setLibcall(RTLIB::BSWAP_I48,        "_i48bswap",   CallingConv::Z80_LibCall   );
  ...
  setLibcall(RTLIB::LLROUND_F32,      "llroundl",    CallingConv::C             );
  setLibcall(RTLIB::LLROUND_F64,      "llroundl",    CallingConv::C             );
  setLibcall(RTLIB::LRINT_F64,        "lrintl",      CallingConv::C             );
  setLibcall(RTLIB::LLRINT_F32,       "llrintl",     CallingConv::C             );
