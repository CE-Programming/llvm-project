...
enum NodeType : unsigned {
  ...
  /// Stack operations
  FIRST_MEMORY_OPCODE,
  POP = FIRST_MEMORY_OPCODE, PUSH,
  LAST_MEMORY_OPCODE = PUSH
};
...
private:
  ...
  void computeKnownBitsForTargetInstr(GISelValueTracking &Analysis, Register Reg,
                                      KnownBits &Known,
  ...
  getInlineAsmMemConstraint(StringRef Constraint) const override;
};
} // End llvm namespace
