...
; EZ80-NEXT:    call __icmpzero
; EZ80-NEXT:    call m, __ineg
; EZ80-NEXT:    ret
  call i24 @llvm.abs.i24(i24 %0, i1 false)
  ret i24 %2
}

declare i48 @llvm.abs.i48(i48, i1)
define i48 @abs.i48(i48) {
; EZ80-LABEL: abs.i48:
; EZ80:       ; %bb.0:
; EZ80-NEXT:    ld iy, 0
; EZ80-NEXT:    add iy, sp
...
; EZ80-NEXT:    call __i48cmpzero
; EZ80-NEXT:    call m, __i48neg
; EZ80-NEXT:    ret
  %2 = call i48 @llvm.abs.i48(i48 %0, i1 false)
  ret i48 %2
}
...
; EZ80-NEXT:    add hl, bc
; EZ80-NEXT:    bit 0, a
; EZ80-NEXT:    jr nz, BB20_5
; EZ80-NEXT:  ; %bb.4:
; EZ80-NEXT:    ex de, hl
; EZ80-NEXT:    private BB20_5
; EZ80-NEXT:  BB20_5:
; EZ80-NEXT:    ret
