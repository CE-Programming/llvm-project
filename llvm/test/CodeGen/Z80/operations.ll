...
; NOTE: Z80 and EZ80-CODE16 modes are excluded because this test contains i24 operations
; NOTE: that are only valid in 24-bit mode (is24Bit() = true). See operations24.ll for
; NOTE: 24-bit specific tests.
...
; EZ80-NEXT:    ld de, (iy + 3)
; EZ80-NEXT:    ld a, (iy + 6)
; EZ80-NEXT:    ld (iy - 5), de
; EZ80-NEXT:    ld l, (iy - 3)
; EZ80-NEXT:    ld (iy - 2), l
; EZ80-NEXT:    ld hl, (iy - 4)
; EZ80-NEXT:    ld h, d
; EZ80-NEXT:    ld l, e
; EZ80-NEXT:    ld c, 0
; EZ80-NEXT:    ld (iy - 1), c
