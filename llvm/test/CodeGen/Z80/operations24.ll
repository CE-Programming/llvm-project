; NOTE: Assertions have been autogenerated by utils/update_llc_test_checks.py UTC_ARGS: --function mul3.i24
...
define i24 @mul3.i24(i24 %x) minsize {
; EZ80-LABEL: mul3.i24:
; EZ80:       ; %bb.0:
; EZ80-NEXT:    call __frameset0
...
define i24 @sdiv.pow2.i24(i24 %0) minsize {
; EZ80-LABEL: sdiv.pow2.i24:
; EZ80:       ; %bb.0:
; EZ80-NEXT:    call __frameset0
...
define i24 @sdiv.neg.pow2.i24(i24 %0) minsize {
; EZ80-LABEL: sdiv.neg.pow2.i24:
; EZ80:       ; %bb.0:
; EZ80-NEXT:    call __frameset0
; EZ80-NEXT:    ld hl, (ix + 6)
; EZ80-NEXT:    ld bc, -8
