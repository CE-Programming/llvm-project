...
; Z80-NEXT:    ld l, (iy + 2)
; Z80-NEXT:    ld h, (iy + 3)
; Z80-NEXT:    call __scmpzero
; Z80-NEXT:    call m, __sneg
; Z80-NEXT:    ret
;
...
; EZ80-CODE16-NEXT:    call __scmpzero
; EZ80-CODE16-NEXT:    call m, __sneg
; EZ80-CODE16-NEXT:    ret
;
; EZ80-LABEL: abs.i16:
; EZ80:       ; %bb.0:
...
; EZ80-NEXT:    call __scmpzero
; EZ80-NEXT:    ; kill: def $hl killed $hl killed $uhl
; EZ80-NEXT:    call m, __sneg
; EZ80-NEXT:    ret
...
; EZ80-CODE16-NEXT:    call m, __lneg
; EZ80-CODE16-NEXT:    ret
;
; EZ80-LABEL: abs.i32:
; EZ80:       ; %bb.0:
...
; EZ80-CODE16-NEXT:    call m, __llneg
...
; Z80-NEXT:  BB63_4:
; Z80-NEXT:    ld a, (ix - 10) ; 1-byte Folded Reload
; Z80-NEXT:    and a, 1
; Z80-NEXT:    ld l, a
; Z80-NEXT:    ld a, e
; Z80-NEXT:    and a, 1
...
; EZ80-CODE16-NEXT:    ld (ix - 5), l
; EZ80-CODE16-NEXT:    ld (ix - 7), bc
; EZ80-CODE16-NEXT:    ld (ix - 9), iy
...
; EZ80-CODE16-NEXT:    ld bc, (ix - 7)
; EZ80-CODE16-NEXT:    ld iy, (ix - 9)
; EZ80-CODE16-NEXT:    call __lcmpu
...
; EZ80-CODE16-NEXT:    ld a, (ix - 5) ; 1-byte Folded Reload
...
; EZ80-NEXT:    ld (ix - 108), e ; 1-byte Folded Spill
...
; EZ80-NEXT:    ld hl, (ix + 6)
; EZ80-NEXT:    ld e, (ix - 117) ; 1-byte Folded Reload
...
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    add iy, de
; EZ80-NEXT:    ld a, (ix - 108) ; 1-byte Folded Reload
; EZ80-NEXT:    lea hl, ix + 0
; EZ80-NEXT:    ld de, -146
; EZ80-NEXT:    push af
; EZ80-NEXT:    add hl, de
...
; EZ80-NEXT:    pop iy
; EZ80-NEXT:    ld h, e
; EZ80-NEXT:    ld (ix - 111), l
; EZ80-NEXT:    ld (ix - 110), h
...
; EZ80-NEXT:    ld e, iyl
; EZ80-NEXT:    ld d, iyh
; EZ80-NEXT:    ld (ix - 114), e
; EZ80-NEXT:    ld (ix - 113), d
; EZ80-NEXT:    push ix
; EZ80-NEXT:    ld bc, -135
; EZ80-NEXT:    add ix, bc
; EZ80-NEXT:    ld hl, (ix + 0)
...
; EZ80-NEXT:    ld c, (ix - 111)
; EZ80-NEXT:    ld b, (ix - 110)
; EZ80-NEXT:    ld c, (ix - 13)
; EZ80-NEXT:    ld (ix - 111), c
; EZ80-NEXT:    ld (ix - 110), b
; EZ80-NEXT:    ld hl, 33
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld hl, (ix - 108)
; EZ80-NEXT:    call __llshl
...
; EZ80-NEXT:    ld l, (ix - 114)
; EZ80-NEXT:    ld h, (ix - 113)
; EZ80-NEXT:    ld (ix - 11), l
...
; EZ80-NEXT:    ld (ix - 109), e ; 1-byte Folded Spill
; EZ80-NEXT:    ld hl, (ix + 18)
...
; EZ80-NEXT:    ld hl, (ix + 6)
; EZ80-NEXT:    ld e, (ix - 118) ; 1-byte Folded Reload
; EZ80-NEXT:    ld a, iyh
; EZ80-NEXT:    call __lmulu
; EZ80-NEXT:    lea iy, ix + 0
; EZ80-NEXT:    ld bc, -147
...
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    pop hl
; EZ80-NEXT:    ld iy, (ix - 115)
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 19
; EZ80-NEXT:    ld de, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    add iy, de
; EZ80-NEXT:    ld a, (ix - 109) ; 1-byte Folded Reload
; EZ80-NEXT:    lea hl, ix + 0
; EZ80-NEXT:    ld de, -141
; EZ80-NEXT:    push af
; EZ80-NEXT:    add hl, de
...
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 50
; EZ80-NEXT:    ld bc, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    add iy, bc
; EZ80-NEXT:    ld (ix - 109), iy
; EZ80-NEXT:    lea hl, ix + 0
; EZ80-NEXT:    ld bc, -160
; EZ80-NEXT:    push af
; EZ80-NEXT:    add hl, bc
...
; EZ80-NEXT:    ld b, (ix - 111)
; EZ80-NEXT:    ld (ix - 33), c
; EZ80-NEXT:    ld (ix - 32), b
; EZ80-NEXT:    ld bc, (ix - 34)
; EZ80-NEXT:    ld iy, 0
; EZ80-NEXT:    ld (ix - 31), iy
...
; EZ80-NEXT:    ld (ix - 118), e ; 1-byte Folded Spill
; EZ80-NEXT:    ld c, iyh
...
; EZ80-NEXT:    ld bc, (iy - 128)
; EZ80-NEXT:    lea iy, ix + 0
; EZ80-NEXT:    lea iy, iy - 44
; EZ80-NEXT:    ld a, (iy - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    call __ladd
; EZ80-NEXT:    ld bc, (ix - 112)
; EZ80-NEXT:    ld a, (ix - 118) ; 1-byte Folded Reload
; EZ80-NEXT:    call __ladd
; EZ80-NEXT:    ld bc, (ix - 127)
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 2
...
; EZ80-NEXT:    ld e, iyl
; EZ80-NEXT:    ld d, iyh
; EZ80-NEXT:    ld (ix - 115), e
; EZ80-NEXT:    ld (ix - 114), d
; EZ80-NEXT:    push ix
; EZ80-NEXT:    ld bc, -133
; EZ80-NEXT:    add ix, bc
; EZ80-NEXT:    ld hl, (ix + 0)
...
; EZ80-NEXT:    ld b, (ix - 111)
; EZ80-NEXT:    ld c, (ix - 13)
; EZ80-NEXT:    ld (ix - 112), c
; EZ80-NEXT:    ld (ix - 111), b
; EZ80-NEXT:    ld hl, 32
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld hl, (ix - 109)
; EZ80-NEXT:    call __llshl
...
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld (ix - 12), hl
; EZ80-NEXT:    ld l, (ix - 115)
; EZ80-NEXT:    ld h, (ix - 114)
; EZ80-NEXT:    ld (ix - 11), l
; EZ80-NEXT:    ld (ix - 10), h
; EZ80-NEXT:    ld de, (ix - 12)
