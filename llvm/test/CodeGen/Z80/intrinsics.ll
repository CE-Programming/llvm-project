...
; EZ80-NEXT:    call __lmulu
; EZ80-NEXT:    ld (ix - 108), hl
; EZ80-NEXT:    ld (ix - 105), e ; 1-byte Folded Spill
; EZ80-NEXT:    ld de, (ix - 117)
; EZ80-NEXT:    ld a, e
; EZ80-NEXT:    ld (ix - 120), a
; EZ80-NEXT:    ld hl, (ix + 18)
; EZ80-NEXT:    ld (ix - 84), hl
; EZ80-NEXT:    ld.sis hl, (ix - 83)
; EZ80-NEXT:    ld (ix - 81), hl
...
; EZ80-NEXT:    or a, a
; EZ80-NEXT:    sbc hl, hl
; EZ80-NEXT:    ld l, (ix - 102) ; 1-byte Folded Reload
; EZ80-NEXT:    ld (ix - 117), hl
; EZ80-NEXT:    ld de, 0
; EZ80-NEXT:    push de
; EZ80-NEXT:    push hl
...
; EZ80-NEXT:    adc a, (ix) ; 1-byte Folded Reload
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld (ix - 105), a ; 1-byte Folded Spill
; EZ80-NEXT:    ccf
; EZ80-NEXT:    sbc hl, hl
; EZ80-NEXT:    push hl
; EZ80-NEXT:    pop bc
...
; EZ80-NEXT:    push af
; EZ80-NEXT:    ex (sp), hl
; EZ80-NEXT:    ld (ix - 21), l
; EZ80-NEXT:    pop hl
; EZ80-NEXT:    ld hl, 9
; EZ80-NEXT:    add hl, sp
; EZ80-NEXT:    ld sp, hl
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld l, (ix - 21)
; EZ80-NEXT:    ; kill: def $h killed $a
; EZ80-NEXT:    ex (sp), hl
; EZ80-NEXT:    pop af
; EZ80-NEXT:    ccf
