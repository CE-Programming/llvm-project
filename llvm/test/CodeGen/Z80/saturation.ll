...
; EZ80-NEXT:    ld hl, (ix + 6)
; EZ80-NEXT:    lea iy, ix + 0
; EZ80-NEXT:    lea iy, iy - 109
; EZ80-NEXT:    ld d, (iy - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    ld e, d
...
; EZ80-NEXT:    ex de, hl
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 121
; EZ80-NEXT:    ld d, (ix - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld e, d
; EZ80-NEXT:    ld a, d
; EZ80-NEXT:    call __ladd
...
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 128
; EZ80-NEXT:    lea ix, ix - 9
; EZ80-NEXT:    ld bc, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 128
; EZ80-NEXT:    lea ix, ix - 12
; EZ80-NEXT:    ld a, (ix - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    call __ladd
; EZ80-NEXT:    lea bc, iy + 0
...
; EZ80-NEXT:    ld (ix - 128), a
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld (iy + 3), de
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 6
; EZ80-NEXT:    ld a, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld a, e
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 26
...
; EZ80-NEXT:    lea iy, ix + 0
; EZ80-NEXT:    lea iy, iy - 20
; EZ80-NEXT:    ld l, (iy - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    lea iy, ix + 0
; EZ80-NEXT:    lea iy, iy - 35
; EZ80-NEXT:    ld (iy - 128), hl
; EZ80-NEXT:    push bc
...
; EZ80-NEXT:    ld (hl), bc
; EZ80-NEXT:    ld l, 0
; EZ80-NEXT:    ld (ix - 88), l
; EZ80-NEXT:    ld de, (ix - 90)
; EZ80-NEXT:    ld d, l
; EZ80-NEXT:    ld hl, (ix + 12)
; EZ80-NEXT:    ld e, h
; EZ80-NEXT:    push ix
...
; EZ80-NEXT:    ld (hl), a
; EZ80-NEXT:    ld c, 0
; EZ80-NEXT:    ld (ix - 59), c
; EZ80-NEXT:    ld hl, (ix - 61)
; EZ80-NEXT:    ld h, c
; EZ80-NEXT:    ld l, c
; EZ80-NEXT:    ld (ix - 58), c
...
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 70
; EZ80-NEXT:    ld bc, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 73
; EZ80-NEXT:    ld a, (ix - 128) ; 1-byte Folded Reload
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    call __ladd
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 76
; EZ80-NEXT:    ld bc, (ix - 128)
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 79
