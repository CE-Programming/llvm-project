...
; EZ80-NEXT:    ld e, h
; EZ80-NEXT:    bit 0, a
; EZ80-NEXT:    jr z, BB14_3
; EZ80-NEXT:  ; %bb.1:
; EZ80-NEXT:    bit 0, a
; EZ80-NEXT:    jr z, BB14_4
; EZ80-NEXT:  BB14_2:
; EZ80-NEXT:    ret
; EZ80-NEXT:  BB14_3:
; EZ80-NEXT:    push bc
...
; EZ80-NEXT:    bit 0, a
; EZ80-NEXT:    ld hl, -1
; EZ80-NEXT:    jr nz, BB22_5
; EZ80-NEXT:  ; %bb.4:
; EZ80-NEXT:    lea hl, iy
; EZ80-NEXT:  BB22_5:
; EZ80-NEXT:    bit 0, a
; EZ80-NEXT:    jr z, BB22_7
; EZ80-NEXT:  ; %bb.6:
; EZ80-NEXT:    ld d, -1
; EZ80-NEXT:  BB22_7:
; EZ80-NEXT:    ld e, d
...
; EZ80-NEXT:    ld d, (iy) ; 1-byte Folded Reload
; EZ80-NEXT:    ld e, d
...
; EZ80-NEXT:    lea iy, ix
; EZ80-NEXT:    lea iy, iy - 128
; EZ80-NEXT:    lea iy, iy - 87
; EZ80-NEXT:    ld (iy), hl
; EZ80-NEXT:    push ix
; EZ80-NEXT:    lea ix, ix - 128
; EZ80-NEXT:    lea ix, ix - 84
; EZ80-NEXT:    ld (ix), e ; 1-byte Folded Spill
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ld l, 0
