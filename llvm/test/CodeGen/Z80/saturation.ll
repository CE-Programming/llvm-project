...
; EZ80-NEXT:    push af
; EZ80-NEXT:    ex (sp), hl
; EZ80-NEXT:    ld (ix - 24), l
; EZ80-NEXT:    pop hl
; EZ80-NEXT:    ld iy, 9
; EZ80-NEXT:    add iy, sp
; EZ80-NEXT:    ld sp, iy
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld l, (ix - 24)
; EZ80-NEXT:    ex (sp), hl
; EZ80-NEXT:    pop af
; EZ80-NEXT:    ccf
; EZ80-NEXT:    ; kill: def $a killed $a
...
; EZ80-NEXT:    call __llshl
; EZ80-NEXT:    ld (ix - 13), hl
; EZ80-NEXT:    ld (ix - 16), de
; EZ80-NEXT:    ld (ix - 19), c
; EZ80-NEXT:    ld (ix - 18), b
; EZ80-NEXT:    pop hl
; EZ80-NEXT:    ld hl, (ix - 27)
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld hl, (ix - 10)
...
; EZ80-NEXT:    push hl
; EZ80-NEXT:    ld hl, (ix - 13)
; EZ80-NEXT:    ld de, (ix - 16)
; EZ80-NEXT:    ld c, (ix - 19)
; EZ80-NEXT:    ld b, (ix - 18)
; EZ80-NEXT:    call __lladd
; EZ80-NEXT:    ld sp, ix
; EZ80-NEXT:    pop ix
; EZ80-NEXT:    ret
