...
#define imp_u(r) " implicit " u(r)
    ...
    {{0xCB, 0x00}, "$b = RLC8g $b," imp_def(f)},
    {{0xCB, 0x01}, "$c = RLC8g $c," imp_def(f)},
    {{0xCB, 0x02}, "$d = RLC8g $d," imp_def(f)},
    {{0xCB, 0x03}, "$e = RLC8g $e," imp_def(f)},
    {{0xCB, 0x04}, "$h = RLC8g $h," imp_def(f)},
    {{0xCB, 0x05}, "$l = RLC8g $l," imp_def(f)},
    {{0xCB, 0x06}, "RLC8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x07}, "$a = RLC8g $a," imp_def(f)},
    {{0xCB, 0x08}, "$b = RRC8g $b," imp_def(f)},
    {{0xCB, 0x09}, "$c = RRC8g $c," imp_def(f)},
    {{0xCB, 0x0A}, "$d = RRC8g $d," imp_def(f)},
    {{0xCB, 0x0B}, "$e = RRC8g $e," imp_def(f)},
    {{0xCB, 0x0C}, "$h = RRC8g $h," imp_def(f)},
    {{0xCB, 0x0D}, "$l = RRC8g $l," imp_def(f)},
    {{0xCB, 0x0E}, "RRC8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x0F}, "$a = RRC8g $a," imp_def(f)},
    {{0xCB, 0x10}, "$b = RL8g $b," imp_def(f) "," imp(f)},
    {{0xCB, 0x11}, "$c = RL8g $c," imp_def(f) "," imp(f)},
    {{0xCB, 0x12}, "$d = RL8g $d," imp_def(f) "," imp(f)},
    {{0xCB, 0x13}, "$e = RL8g $e," imp_def(f) "," imp(f)},
    {{0xCB, 0x14}, "$h = RL8g $h," imp_def(f) "," imp(f)},
    {{0xCB, 0x15}, "$l = RL8g $l," imp_def(f) "," imp(f)},
    {{0xCB, 0x16}, "RL8p " u(hl) "," imp_def(f) "," imp(f)},
    {{0xCB, 0x17}, "$a = RL8g $a," imp_def(f) "," imp(f)},
    {{0xCB, 0x18}, "$b = RR8g $b," imp_def(f) "," imp(f)},
    {{0xCB, 0x19}, "$c = RR8g $c," imp_def(f) "," imp(f)},
    {{0xCB, 0x1A}, "$d = RR8g $d," imp_def(f) "," imp(f)},
    {{0xCB, 0x1B}, "$e = RR8g $e," imp_def(f) "," imp(f)},
    {{0xCB, 0x1C}, "$h = RR8g $h," imp_def(f) "," imp(f)},
    {{0xCB, 0x1D}, "$l = RR8g $l," imp_def(f) "," imp(f)},
    {{0xCB, 0x1E}, "RR8p " u(hl) "," imp_def(f) "," imp(f)},
    {{0xCB, 0x1F}, "$a = RR8g $a," imp_def(f) "," imp(f)},
    {{0xCB, 0x20}, "$b = SLA8g $b," imp_def(f)},
    {{0xCB, 0x21}, "$c = SLA8g $c," imp_def(f)},
    {{0xCB, 0x22}, "$d = SLA8g $d," imp_def(f)},
    {{0xCB, 0x23}, "$e = SLA8g $e," imp_def(f)},
    {{0xCB, 0x24}, "$h = SLA8g $h," imp_def(f)},
    {{0xCB, 0x25}, "$l = SLA8g $l," imp_def(f)},
    {{0xCB, 0x26}, "SLA8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x27}, "$a = SLA8g $a," imp_def(f)},
    {{0xCB, 0x28}, "$b = SRA8g $b," imp_def(f)},
    {{0xCB, 0x29}, "$c = SRA8g $c," imp_def(f)},
    {{0xCB, 0x2A}, "$d = SRA8g $d," imp_def(f)},
    {{0xCB, 0x2B}, "$e = SRA8g $e," imp_def(f)},
    {{0xCB, 0x2C}, "$h = SRA8g $h," imp_def(f)},
    {{0xCB, 0x2D}, "$l = SRA8g $l," imp_def(f)},
    {{0xCB, 0x2E}, "SRA8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x2F}, "$a = SRA8g $a," imp_def(f)},
    {{0xCB, 0x30}, "$b = SLI8g $b," imp_def(f)},
    {{0xCB, 0x31}, "$c = SLI8g $c," imp_def(f)},
    {{0xCB, 0x32}, "$d = SLI8g $d," imp_def(f)},
    {{0xCB, 0x33}, "$e = SLI8g $e," imp_def(f)},
    {{0xCB, 0x34}, "$h = SLI8g $h," imp_def(f)},
    {{0xCB, 0x35}, "$l = SLI8g $l," imp_def(f)},
    {{0xCB, 0x36}, "SLI8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x37}, "$a = SLI8g $a," imp_def(f)},
    {{0xCB, 0x38}, "$b = SRL8g $b," imp_def(f)},
    {{0xCB, 0x39}, "$c = SRL8g $c," imp_def(f)},
    {{0xCB, 0x3A}, "$d = SRL8g $d," imp_def(f)},
    {{0xCB, 0x3B}, "$e = SRL8g $e," imp_def(f)},
    {{0xCB, 0x3C}, "$h = SRL8g $h," imp_def(f)},
    {{0xCB, 0x3D}, "$l = SRL8g $l," imp_def(f)},
    {{0xCB, 0x3E}, "SRL8p " u(hl) "," imp_def(f)},
    {{0xCB, 0x3F}, "$a = SRL8g $a," imp_def(f)},
    ...
    {{0xED, 0x3C}, "TST8ag $a," imp_def(f) "," imp(a)},
    {{0xED, 0x3E}, "LD" w "pr " u(hl) ", " u(iy)},
    {{0xED, 0x3F}, "LD" w "pr " u(hl) ", " u(ix)},
    {{0xED, 0x40}, "$b = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x41}, "OUT" w "pg $b," imp_u(bc)},
    ...
    {{0xED, 0x48}, "$c = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x49}, "OUT" w "pg $c," imp_u(bc)},
    ...
    {{0xED, 0x50}, "$d = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x51}, "OUT" w "pg $d," imp_u(bc)},
    ...
    {{0xED, 0x58}, "$e = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x59}, "OUT" w "pg $e," imp_u(bc)},
    ...
    {{0xED, 0x60}, "$h = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x61}, "OUT" w "pg $h," imp_u(bc)},
    ...
    {{0xED, 0x68}, "$l = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x69}, "OUT" w "pg $l," imp_u(bc)},
    ...
    {{0xED, 0x76}, "SLP"},
    {{0xED, 0x78}, "$a = IN" w "gp" imp_def(f) "," imp_u(bc)},
    {{0xED, 0x79}, "OUT" w "pg $a," imp_u(bc)},
