...
public:
  explicit NoInitMachineModuleInfoWrapperPass(const LLVMTargetMachine *TM)
...
protected:
  ...
  void SetUp() override {
    ...
    TM = std::unique_ptr<TargetMachine>(T->createTargetMachine(
        TargetTriple.str(), "", "", Options, std::nullopt));
    if (!TM)
      GTEST_SKIP();
  }
...
...
  ...
  auto *MMIWP = new NoInitMachineModuleInfoWrapperPass(
