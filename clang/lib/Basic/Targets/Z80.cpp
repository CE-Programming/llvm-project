...
void Z80TargetInfoBase::getTargetDefines(const LangOptions &Opts,
  ...
  Builder.defineMacro("__UCHAR_MAX__", "255");
  Builder.defineMacro("__USHRT_MAX__", "65535");
  Builder.defineMacro("__ULONG_MAX__", "4294967295UL");
  Builder.defineMacro("__ULONG_LONG_MAX__", "18446744073709551615ULL");
}
...
void Z80TargetInfo::getTargetDefines(const LangOptions &Opts,
  ...
  Builder.defineMacro("__UINT_MAX__", "65535U");
...
void EZ80TargetInfo::getTargetDefines(const LangOptions &Opts,
  ...
  Builder.defineMacro("__UINT_MAX__", "16777215U");
}
